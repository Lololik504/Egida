...
class BlindArea(MyModel):
    ...
    blind_area_act = models.FileField(verbose_name="Акт обследования технического состояния", upload_to=inn_dir_path, default=None, null=True, blank=True)
    blind_area_photo = models.FileField(verbose_name="Фото отмостки", upload_to=inn_dir_path, default=None, null=True, blank=True)
