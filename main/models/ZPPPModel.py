...
class ZPPP(MyModel):
    ...
    zppp_height = models.IntegerField(verbose_name='Высота ЗППП', null=True, blank=True)
    zppp_square = models.IntegerField(verbose_name='Общая площадь ЗППП', null=True, blank=True)
